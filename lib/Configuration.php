...
namespace GeminiCommerce\AiProductDataEnhancer;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (GeminiCommerce\AiProductDataEnhancer) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: version not set' . PHP_EOL;
