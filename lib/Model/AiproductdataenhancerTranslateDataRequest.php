...
/**
 * AiproductdataenhancerTranslateDataRequest Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\AiProductDataEnhancer
 * @author   OpenAPI Generator team
 ...
 */
class AiproductdataenhancerTranslateDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'aiproductdataenhancerTranslateDataRequest';
    ...
    */
    ...
    /**
     * Gets data_to_translate
     *
     * @return \GeminiCommerce\AiProductDataEnhancer\Model\AiproductdataenhancerDataToTranslate[]|null
     */
    public function getDataToTranslate()
    {
        return $this->container['data_to_translate'];
    }

    /**
     * Sets data_to_translate
     *
     * @param \GeminiCommerce\AiProductDataEnhancer\Model\AiproductdataenhancerDataToTranslate[]|null $data_to_translate data_to_translate
     *
     * @return self
     */
    public function setDataToTranslate($data_to_translate)
    {
        if (is_null($data_to_translate)) {
            throw new \InvalidArgumentException('non-nullable data_to_translate cannot be null');
        }
        $this->container['data_to_translate'] = $data_to_translate;
